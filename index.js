...
console.log("Connecting Dark alfha bot 😻...");
...
console.log('Bot connected to Dark alfha whatsapp ✅')

let up = `DARK-ALFHA-BOT connected successful ✅\n\nPREFIX: ${prefix}`;
...
app.get("/", (req, res) => {
res.send("Dark alfha, bot started✅");
});
